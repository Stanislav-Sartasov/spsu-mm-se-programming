...
class Connection(private val connection: HttpURLConnection, private val streamDi: DI): IConnection {
    private var responseCode: Int = 0
    private val stream: Stream by streamDi.instance()
