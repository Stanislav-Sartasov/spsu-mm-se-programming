...
internal class HiLoStrategyTest {
    ...
    inner class GetNextBet {
        ...
        fun `get next bet with big enough bankroll with positive true count`() {
            val discard = List(size = 32) { TWO_OF_CLUBS } +
    ...
    private companion object {
        ...
        fun gameStatesWithNextMoves() = listOf(
            stateBy(dealer = FOUR_OF_DIAMONDS, player = listOf(ACE_OF_HEARTS, EIGHT_OF_CLUBS), DISCARD_TC_3) to HIT,
            stateBy(dealer = FOUR_OF_DIAMONDS, player = listOf(ACE_OF_HEARTS, EIGHT_OF_CLUBS)) to STAND,
            stateBy(dealer = SIX_OF_DIAMONDS, player = listOf(ACE_OF_HEARTS, EIGHT_OF_CLUBS), DISCARD_TC_1) to HIT,
            stateBy(dealer = SIX_OF_DIAMONDS, player = listOf(ACE_OF_HEARTS, EIGHT_OF_CLUBS)) to STAND,
            stateBy(dealer = TWO_OF_CLUBS, player = listOf(ACE_OF_HEARTS, SIX_OF_DIAMONDS), DISCARD_TC_1) to STAND,
            ...
            stateBy(dealer = NINE_OF_HEARTS, player = listOf(TEN_OF_CLUBS, SIX_OF_DIAMONDS), DISCARD_TC_4) to STAND,
            stateBy(dealer = NINE_OF_HEARTS, player = listOf(TEN_OF_CLUBS, SIX_OF_DIAMONDS)) to HIT,
            stateBy(dealer = TEN_OF_CLUBS, player = listOf(NINE_OF_HEARTS, SIX_OF_DIAMONDS), DISCARD_TC_4) to STAND,
            stateBy(dealer = TEN_OF_CLUBS, player = listOf(NINE_OF_HEARTS, SIX_OF_DIAMONDS)) to HIT,
            stateBy(dealer = TWO_OF_CLUBS, player = listOf(FOUR_OF_DIAMONDS, NINE_OF_HEARTS), DISCARD_TC_NEG_1) to HIT,
            stateBy(dealer = TWO_OF_CLUBS, player = listOf(FOUR_OF_DIAMONDS, NINE_OF_HEARTS)) to STAND,
            stateBy(dealer = TWO_OF_CLUBS, player = listOf(TEN_OF_CLUBS, TWO_OF_CLUBS), DISCARD_TC_3) to STAND,
            stateBy(dealer = TWO_OF_CLUBS, player = listOf(TEN_OF_CLUBS, TWO_OF_CLUBS)) to HIT,
            stateBy(dealer = ACE_OF_HEARTS, player = listOf(NINE_OF_HEARTS, TWO_OF_CLUBS), DISCARD_TC_1) to STAND,
            stateBy(dealer = ACE_OF_HEARTS, player = listOf(NINE_OF_HEARTS, TWO_OF_CLUBS)) to HIT,
            stateBy(dealer = ACE_OF_SPADES, player = listOf(FOUR_OF_DIAMONDS, SIX_OF_DIAMONDS), DISCARD_TC_4) to STAND,
            stateBy(dealer = ACE_OF_SPADES, player = listOf(FOUR_OF_DIAMONDS, SIX_OF_DIAMONDS)) to HIT,
            stateBy(dealer = TWO_OF_CLUBS, player = listOf(TWO_OF_CLUBS, SEVEN_OF_HEARTS), DISCARD_TC_1) to STAND,
        ...
        val DISCARD_TC_NEG_1 = List(size = 10) { ACE_OF_SPADES }
        val DISCARD_TC_1 = List(size = 10) { TWO_OF_CLUBS }
        val DISCARD_TC_2 = List(size = 20) { TWO_OF_CLUBS }
        val DISCARD_TC_3 = List(size = 25) { TWO_OF_CLUBS }
        val DISCARD_TC_4 = List(size = 30) { TWO_OF_CLUBS }

        fun stateBy(dealer: Card, player: List<Card>, discard: List<Card> = emptyList()) = GameState.InGame(
            table = TABLE_INFO,
