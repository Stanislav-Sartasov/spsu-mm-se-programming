...
object MeteoComposeMessagesWizard {
    ...
    val MeteoState.isLoading
        get() = when (this) {
            MeteoState.Uninitialised -> false
            is MeteoState.Initialised -> weatherList.any { it.value === LoadingState.Loading }
        }
