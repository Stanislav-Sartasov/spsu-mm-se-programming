   ...
   if (CheckTangle(a,b,c))
    {
       ...
       printf("Угол № 1 - %.2lf можно представить в виде: ",  a1);  transleteinthenormalangle(a1);
       printf("Угол № 2 - %.2lf можно представить в виде: ",  b1);  transleteinthenormalangle(b1);
       printf("Угол № 3 - %.2lf можно представить в виде: ",  c1);  transleteinthenormalangle(c1);
    }
    else
    {
