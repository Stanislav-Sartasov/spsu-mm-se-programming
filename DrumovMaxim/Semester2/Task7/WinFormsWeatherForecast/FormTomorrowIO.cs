...
namespace WinFormsWeatherForecast
{
    public partial class FormTomorrowIO : Form
    {
        ...
        private void PrintWeather_Click(object sender, EventArgs e)
        {
            BindingSource bindingSource = new BindingSource();
            
            WeatherData.UpdateWeather(typeof(TomorrowIO));
            ...
            else
            {
                ...
                ExceptionMessage.DataBindings.Add("Text", bindingSource, "ExceptionMessage");
            }
        }
