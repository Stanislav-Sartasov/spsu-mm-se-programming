...
class BmpReadWriteTests {
	...
	fun bmpReadWriteTest24() {
		val firstBmp = readBmp("input/bmpReadTest24.bmp")
		firstBmp.write("input/newBmpReadTest24.bmp")
		val secondBmp = readBmp("input/newBmpReadTest24.bmp")
		assert(firstBmp.equals(secondBmp))
	}

	@Test
	fun bmpReadWriteTest32() {
		val firstBmp = readBmp("input/bmpReadTest32.bmp")
		firstBmp.write("input/newBmpReadTest32.bmp")
		val secondBmp = readBmp("input/newBmpReadTest32.bmp")
		assert(firstBmp.equals(secondBmp))
	}

	@Test
	fun bmpReadTest24() {
		val curBmp24 = readBmp("input/bmpReadTest24.bmp")
		assert(curBmp24.equals(testBmp24))
	}

	@Test
	fun bmpReadTest32() {
		val curBmp32 = readBmp("input/bmpReadTest32.bmp")
		assert(curBmp32.equals(testBmp32))
	}

	@Test
	fun bmpWriteTest24() {
		testBmp24.write("input/bmpWriteTest24.bmp")
		assert(readBmp("input/bmpWriteTest24.bmp").equals(testBmp24))
	}

	@Test
	fun bmpWriteTest32() {
		testBmp32.write("input/bmpWriteTest32.bmp")
		assert(readBmp("input/bmpWriteTest32.bmp").equals(testBmp32))
	}
}