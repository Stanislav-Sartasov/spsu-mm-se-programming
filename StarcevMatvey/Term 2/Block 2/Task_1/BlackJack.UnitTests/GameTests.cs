...
namespace BlackJack.UnitTests
{
    public class GameTests
    {
        ...
        public void EndTurnTest()
        {
            ...
            Game game = new Game(players);
            firstGoodBot.TookCard(new Card("H", "A"));
            firstGoodBot.TookCard(new Card("H", "10"));
            firstGoodBot.MakeBet(100);
            secondGoodBot.TookCard(new Card("H", "A"));
            secondGoodBot.MakeBet(100);
            game.Croupier.TookCard(new Card("H", "A"));
            thirdGoodBot.TookCard(new Card("H", "2"));
            thirdGoodBot.MakeBet(1000);
            fourthGoodBot.TookCard(new Card("H", "10"));
            fourthGoodBot.TookCard(new Card("H", "10"));
