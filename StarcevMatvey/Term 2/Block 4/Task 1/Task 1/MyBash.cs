...
namespace Task_1
{
    public class MyBash
    {
        ...
        public void Wc()
        {
            ...
            foreach (var a in CurrentArguments)
            {
                var countOfLines = 0;
                var countOfWords = 0;
                var countOfBytes = 0;
                var arg = GetLocalVar(a);
        ...
        public void ProcessStart()
        {
            ...
            catch
            {
                ...
                {
                    errorMessenges.Add($"{Invite}: {a}: Command not found");
                    //CurrentArguments = new List<string>();
                    //return;
                }
            }
