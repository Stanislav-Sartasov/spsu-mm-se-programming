...
namespace Task_1.UnitTests
{
    public class AnalyzerTests
    {
        ...
        public void AnalyzeTest()
        {
            ...
            data = new List<(string str, TypeOfParsedStr type)> { ("some.exe", TypeOfParsedStr.ProcessStart) };
            a = new Analyzer(data);
            a.Analyze();
            Assert.IsTrue(a.IsAnalyzed);
            ...
            {
                ("echo", TypeOfParsedStr.Command),
                ("argument1", TypeOfParsedStr.Argument),
                ("argument2", TypeOfParsedStr.Argument)
            };
            a = new Analyzer(data);
            a.Analyze();
            Assert.IsTrue(a.IsAnalyzed);
