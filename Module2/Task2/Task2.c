...
int main()
{
	...
	printf("Введите значение для размена:");
	...
	{
		printf("Количество возможных вариантов %d для размена %d пенсов", 2, enter_znach);
	}
	else
	{
		enter_znach += 1;
		...
		printf("Количество возможных вариантов %d для размена %d пенсов", variants[enter_znach - 1][7], enter_znach - 1);
