        ...
        public override bool Parse()
        {
            ...
            if (successToParsing)
            {
                try
                {
                    ...
                    string precipitation = "Precipitation type: " + ((PrecipitationIO)(int)data["values"]["precipitationType"]).ToString() + $"\nPrecipitation intensity: {data["values"]["precipitationIntensity"]} mm/hr\nPrecipitation probability: {data["values"]["precipitationProbability"]} %";
