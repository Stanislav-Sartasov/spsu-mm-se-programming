...
{
    public abstract class ABot : AParticipant, ICloneable
    {
        ...
        public object Clone()
        {
            var bot = (ABot)this.MemberwiseClone();
            ACard[] copyCards = new ACard[CardsInHand.Count()];
            CardsInHand.CopyTo(copyCards);
            bot.CardsInHand = copyCards.ToList();
            return bot;
        }
    }
}
