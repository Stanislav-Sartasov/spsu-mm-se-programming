...
namespace Weather
{
	public static class ConsoleWriter
	{
		...
		public static void WriteGreeting()
		{
			...
			Console.WriteLine();
			Console.WriteLine("Write in console Tomorrow.io to show Tomorrow.io's forecast.");
			Console.WriteLine("Write in console StormGlass.io to show StormGlass.io's forecast.");
			Console.WriteLine();
			Console.WriteLine();
		}
