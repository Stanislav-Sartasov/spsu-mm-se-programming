...
namespace Task1.Tests
{
    public class GaussFilter
    {
        ...
        public void Gauss()
        {
            ...
            FileStream fsT = new FileStream(@"..\..\..\..\..\Block1\Task1.Test\TestFiles\sunG3_t.bmp", FileMode.Open);
            ...
            FileStream fO = new FileStream(@"..\..\..\..\..\Block1\Task1.Test\TestFiles\sunG3_new.bmp", FileMode.Create);
            ...
            fS = new FileStream(@"..\..\..\..\..\Block1\Task1.Test\TestFiles\sunG3_new.bmp", FileMode.Open);
