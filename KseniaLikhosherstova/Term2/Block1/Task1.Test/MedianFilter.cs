...
{ 
    public class MedianFilter
    {
        ...
        public void Median()
        {
            ...
            FileStream fsT = new FileStream(@"..\..\..\..\Task1.Test\TestFiles\sunM3_t.bmp", FileMode.Open);
            ...
            FileStream fO = new FileStream(@"..\..\..\..\Task1.Test\TestFiles\sunM3_new.bmp", FileMode.Create);
            ...
            fS = new FileStream(@"..\..\..\..\Task1.Test\TestFiles\sunM3_new.bmp", FileMode.Open);
