...
namespace Task1.Tests
{
    public class MedianFilter
    {
        ...
        public void Median()
        {
            ...
            FileStream fsT = new FileStream(@"..\..\..\..\..\Block1\Task1.Test\TestFiles\sunM3_t.bmp", FileMode.Open);
            ...
            FileStream fO = new FileStream(@"..\..\..\..\..\Block1\Task1.Test\TestFiles\sunM3_new.bmp", FileMode.Create);
            ...
            fS = new FileStream(@"..\..\..\..\..\Block1\Task1.Test\TestFiles\sunM3_new.bmp", FileMode.Open);
