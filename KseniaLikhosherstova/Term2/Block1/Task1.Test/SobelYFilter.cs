...
namespace Task1.Test
{
    public class SobelYFilter
    {
        ...
        public void SobelY()
        {
            ...
            FileStream fsT = new FileStream(@"..\..\..\..\Task1.Test\TestFiles\sunSY_t.bmp", FileMode.Open);
            ...
            FileStream fO = new FileStream(@"..\..\..\..\Task1.Test\TestFiles\sunSY_new.bmp", FileMode.Create);
            ...
            fS = new FileStream(@"..\..\..\..\Task1.Test\TestFiles\sunSY_new.bmp", FileMode.Open);
