...
namespace Task1.Tests
{
    public class SobelXFilter
    {
        ...
        public void SobelX()
        {
            ...
            FileStream fsT = new FileStream(@"..\..\..\..\Task1.Test\TestFiles\sunSX_t.bmp", FileMode.Open);
            ...
            FileStream fO = new FileStream(@"..\..\..\..\Task1.Test\TestFiles\sunSX_new.bmp", FileMode.Create);
            ...
            fS = new FileStream(@"..\..\..\..\Task1.Test\TestFiles\sunSX_new.bmp", FileMode.Open);
