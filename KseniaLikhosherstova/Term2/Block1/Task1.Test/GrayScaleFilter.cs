...
namespace Task1.Tests
{
    public class GrayScaleFilter
    {
        ...
        public void GrayScale()
        {
            ...
            FileStream fsT = new FileStream(@"..\..\..\..\..\Task1\Task1.Test\TestFiles\sunG_t.bmp", FileMode.Open);
            ...
            FileStream fO = new FileStream(@"..\..\..\..\..\Task1\Task1.Test\TestFiles\sunG_new.bmp", FileMode.Create);
            ...
            fS = new FileStream(@"..\..\..\..\..\Task1\Task1.Test\TestFiles\sunG_new.bmp", FileMode.Open);
