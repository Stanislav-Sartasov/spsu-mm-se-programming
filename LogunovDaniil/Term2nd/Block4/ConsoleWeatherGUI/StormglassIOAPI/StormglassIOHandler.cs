		...
		public override WeatherDataContainer? ParseJSONObject(string json)
		{
			try
			{
				using (JsonDocument doc = JsonDocument.Parse(json))
				{
					...
					double windAngle = weather.GetProperty("windDirection").GetProperty(StormSource).GetDouble();
					...
					return new WeatherDataContainer
					{
						...
						TempC = temp,
						TempF = GeneralConversions.ConvertTempFromCToF(temp),
						...
						WindDirection = GeneralConversions.GetDirectionFromAngle(windAngle),
