...
namespace Blackjack
{
    public class GameTable
    {
        ...
        public GameTable(BotName name, int minBet = 5)
        {
            switch (name)
            {
                case BotName.HiLowStrategyBot:
                    Player = new HiLowStrategyBot();
                    break;
                case BotName.HiOptIIStrategyBot:
                    Player = new HiOptIIStrategyBot();
                    break;
                case BotName.WinningStrategyBot:
                    Player = new WinningStrategyBot();
                    break;
            }
        ...
        private void Finish()
        {
            ...
            {
                Player.Play(playerHand, Dealer.Cards); // let bots to make some actions in the and of the round
            }
